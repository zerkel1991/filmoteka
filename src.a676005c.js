...
async function getMovieDets(id) {
  const emptyLibraryNotification = collectionEl.innerHTML = '<li class="item__empty"><h2 class="empty__title">You have not watched any movies yet!</h2><a class="empty__link" href="./index.html">Сlick here to select films from the collection...</a></li>'; //Adding the orange color & shadow to the active class
...
async function getMovieQueue(id) {
  const emptyLibraryNotification = collectionEl.innerHTML = '<li class="item__empty"><h2 class="empty__title">You have not added any films to your queue! </h2><a class="empty__link" href="./index.html">Сlick here to select films from the collection...</a></li>'; //Adding the orange color & shadow to the active class
...
},{"../scripts/refs":"FbTA","./searchMovie":"tJpv","./renderMainPage":"q8Z5","./emptyLibrary":"My4n"}],"HzNH":[function(require,module,exports) {
"use strict";
